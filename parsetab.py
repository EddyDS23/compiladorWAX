...
_lr_productions = [
  ...
  ('program -> program statement','program',2,'p_program','parser.py',25),
  ('program -> statement','program',1,'p_program','parser.py',26),
  ('program -> empty','program',1,'p_program','parser.py',27),
  ('statement -> COMMENT_LINE','statement',1,'p_statement_comment','parser.py',40),
  ('statement -> COMMENT_BLOCK','statement',1,'p_statement_comment','parser.py',41),
  ('statement -> WAX IDENT COLON IDENT EQUAL expression SEMI','statement',7,'p_statement_decl','parser.py',45),
  ('statement -> IDENT EQUAL expression SEMI','statement',4,'p_statement_assignment','parser.py',51),
  ('statement -> ident_list EQUAL expression_list SEMI','statement',4,'p_statement_multi_assignment','parser.py',56),
  ('statement -> IF LPAREN expression RPAREN LBRACE program RBRACE','statement',7,'p_statement_if','parser.py',60),
  ('statement -> IF LPAREN expression RPAREN LBRACE program RBRACE ELSE LBRACE program RBRACE','statement',11,'p_statement_if','parser.py',61),
  ('statement -> WHILE LPAREN expression RPAREN LBRACE program RBRACE','statement',7,'p_statement_while','parser.py',68),
  ('statement -> PRINT LPAREN expression RPAREN SEMI','statement',5,'p_statement_print','parser.py',72),
  ('return_type -> IDENT','return_type',1,'p_return_type','parser.py',76),
  ('return_type -> VOID','return_type',1,'p_return_type','parser.py',77),
  ('statement -> RETURN expression_list SEMI','statement',3,'p_statement_return_value','parser.py',81),
  ('statement -> RETURN SEMI','statement',2,'p_statement_return_empty','parser.py',85),
  ('statement -> WAX FUNCTION IDENT COLON return_type LPAREN paramlist RPAREN LBRACE program RBRACE','statement',11,'p_statement_func','parser.py',89),
  ...
  ('expression -> expression STAR expression','expression',3,'p_expression_binop','parser.py',97),
  ('expression -> expression SLASH expression','expression',3,'p_expression_binop','parser.py',98),
  ('expression -> expression LT expression','expression',3,'p_expression_comparison','parser.py',102),
  ('expression -> expression LE expression','expression',3,'p_expression_comparison','parser.py',103),
  ('expression -> expression GT expression','expression',3,'p_expression_comparison','parser.py',104),
  ('expression -> expression GE expression','expression',3,'p_expression_comparison','parser.py',105),
  ('expression -> expression EQEQ expression','expression',3,'p_expression_comparison','parser.py',106),
  ('expression -> expression NOTEQ expression','expression',3,'p_expression_comparison','parser.py',107),
  ('expression -> expression AND expression','expression',3,'p_expression_logic','parser.py',111),
  ('expression -> expression OR expression','expression',3,'p_expression_logic','parser.py',112),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',116),
  ('expression -> INT','expression',1,'p_expression_number','parser.py',120),
  ('expression -> DOUBLE','expression',1,'p_expression_number','parser.py',121),
  ('expression -> STRING','expression',1,'p_expression_string','parser.py',126),
  ('expression -> BOOL','expression',1,'p_expression_bool','parser.py',130),
  ('expression -> IDENT','expression',1,'p_expression_ident','parser.py',134),
  ('expression -> LBRACKET list_items RBRACKET','expression',3,'p_expression_list','parser.py',138),
  ('list_items -> list_items COMMA expression','list_items',3,'p_list_items','parser.py',142),
  ('list_items -> expression','list_items',1,'p_list_items','parser.py',143),
  ('list_items -> empty','list_items',1,'p_list_items','parser.py',144),
  ('expression -> IDENT LBRACKET expression RBRACKET','expression',4,'p_expression_list_access','parser.py',149),
  ('expression -> IDENT LPAREN arglist RPAREN','expression',4,'p_expression_func_call','parser.py',153),
  ('expression -> STR LPAREN expression RPAREN','expression',4,'p_expression_str_call','parser.py',158),
  ('expression -> INPUT LPAREN RPAREN','expression',3,'p_expression_input','parser.py',162),
  ('arglist -> arglist COMMA expression','arglist',3,'p_arglist','parser.py',167),
  ('arglist -> expression','arglist',1,'p_arglist','parser.py',168),
  ('arglist -> empty','arglist',1,'p_arglist','parser.py',169),
  ('expression_list -> expression_list COMMA expression','expression_list',3,'p_expression_list_values','parser.py',174),
  ('expression_list -> expression','expression_list',1,'p_expression_list_values','parser.py',175),
  ('ident_list -> ident_list COMMA IDENT','ident_list',3,'p_ident_list','parser.py',180),
  ('ident_list -> IDENT','ident_list',1,'p_ident_list','parser.py',181),
  ('paramlist -> paramlist COMMA IDENT COLON IDENT','paramlist',5,'p_paramlist','parser.py',186),
  ('paramlist -> IDENT COLON IDENT','paramlist',3,'p_paramlist','parser.py',187),
  ('paramlist -> empty','paramlist',1,'p_paramlist','parser.py',188),
